...
namespace trees.win_forms
{
    ...
    {
        [DM(Name="t")]  public string Text         { get; set; }
        [DM(Name="w")]  public int    Width        { get; set; }
        [DM(Name="di")] public int    DisplayIndex { get; set; }
        [DM(Name="v")]  public bool   Visible      { get; set; }
    ...
    {
        [DM(Name="n")]   public string Name { get; set; }
        [DM(Name="cws")] public List< DGVColumnWidth > ColumnWidths { get; set; }
    ...
    {
        [DM(Name="n")] public string Name     { get; set; }
        [DM(Name="d")] public int    Distance { get; set; }
    ...
    {
        [DM(Name="r")     ] public Rectangle       Rect        { get; set; }
        [DM(Name="ws")    ] public FormWindowState WindowState { get; set; }

        [DM(Name="sds")   ] public List< SplitDistance   > SplitDistances  { get; set; }
        [DM(Name="dgvcws")] public List< DGVColumnWidths > DGVColumnWidths { get; set; }
        ...
        [IG] private Dictionary< string, DGVColumnWidths > _dgvcws_Dict;
        ...
        [IG] private Dictionary< string, SplitDistance > _sds_Dict;
